...
func TestSubmitBallot(t *testing.T) {
	...
	voted, _ := vm.HasVoted(context.Background(), votermap.HashEGN("8501011234"))
	if !voted {
...
func TestSubmitOverride(t *testing.T) {
	...
	id, _, _ := vm.GetActiveBallotID(context.Background(), votermap.HashEGN("8501011234"))
	if id != "b2" {
...
func TestRequireKey(t *testing.T) {
	vm := votermap.NewMemoryStore()
	vm.Record(context.Background(), votermap.HashEGN("1111111111"), "b1", "online", 1000)
...
func TestActiveSet(t *testing.T) {
	vm := votermap.NewMemoryStore()
	vm.Record(context.Background(), votermap.HashEGN("1111111111"), "b1", "online", 1000)
	vm.Record(context.Background(), votermap.HashEGN("2222222222"), "b2", "online", 1000)
