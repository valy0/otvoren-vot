...
func NewRouter(b *board.Board, internalAPIKey string, allowedOrigins []string, electionID string) http.Handler {
	...
	publicMux.HandleFunc("GET /api/v1/election", handleGetElection(electionID))
